# 🚗 Gariscan - Vehicle Damage Assessment App  
...
- ⚠️ **Severity Classification** – Categorize damage severity (minor, moderate, severe).  
- 💵 **Cost Estimation** – Provide repair cost estimates based on detected damage.  
